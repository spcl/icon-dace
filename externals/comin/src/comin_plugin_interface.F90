...
MODULE comin_plugin_interface
  ...
  INTEGER, PARAMETER :: COMIN_METADATA_TYPEID_UNDEFINED = -1
  INTEGER, PARAMETER :: COMIN_METADATA_TYPEID_INTEGER   = 0
  INTEGER, PARAMETER :: COMIN_METADATA_TYPEID_REAL      = 1
  INTEGER, PARAMETER :: COMIN_METADATA_TYPEID_CHARACTER = 2
  INTEGER, PARAMETER :: COMIN_METADATA_TYPEID_LOGICAL   = 3
