...
export DACE_LDFLAGS="-L${VELOCITY_PATH} "
export DACE_LIBS="-lvelocity_gpu_stage5_standalone_release"
export DACE_FCFLAGS="-L${VELOCITY_PATH} -Wl,-rpath,${VELOCITY_PATH}"
export LD_LIBRARY_PATH="${VELOCITY_PATH}:${LD_LIBRARY_PATH}"
# -DDACE_SUBST_VERIFY=1  -DDACE_SUBST_ENABLE=1
export F90=mpifort
export FC=mpifort
export F77=mpifort
export CC=mpicxx
...
export LD_LIBRARY_PATH=" \
  ...
  ${LD_LIBRARY_PATH} \
"
../../config/cscs/ault_yakup_dace_cpu && make -j && ./make_runscripts --all && cd run 
