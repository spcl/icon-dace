...
/* Compiler */
#define COMPILER "/apps/ault/spack/opt/spack/linux-centos8-zen/gcc-8.4.1/gcc-10.2.0-fqf4ze2mfclmx6e7ehrjckznpoqnevmi/bin/gcc -g -O2"

/* Compiler version */
#define COMP_VERSION "gcc (Spack GCC) 10.2.0"
