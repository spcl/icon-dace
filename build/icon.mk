...
srcdir:= /scratch/pmazumde/paper-icon-dace/icon-dace/icon-model
...
# packages:
bundled_srcdirs =  externals/cdi externals/mtime externals/fortran-support externals/math-support externals/math-interpolation

# Relative paths to the root build directories of all bundled packages:
bundled_builddirs= externals/cdi externals/mtime externals/fortran-support/build externals/math-support/build externals/math-interpolation/build
...
ARFLAGS= cr
RANLIB= ranlib
CC= /apps/ault/spack/opt/spack/linux-centos8-zen/gcc-8.4.1/gcc-10.2.0-fqf4ze2mfclmx6e7ehrjckznpoqnevmi/bin/gcc
FC= /apps/ault/spack/opt/spack/linux-centos8-zen/gcc-8.4.1/gcc-10.2.0-fqf4ze2mfclmx6e7ehrjckznpoqnevmi/bin/gfortran
CXX= /apps/ault/spack/opt/spack/linux-centos8-zen/gcc-8.4.1/gcc-10.2.0-fqf4ze2mfclmx6e7ehrjckznpoqnevmi/bin/g++
CUDACXX= 
HIPCXX= 
PYTHON= python3
CMAKE= cmake
...
FCFLAGS= -Iexternals/cdi/src -Iexternals/mtime/src -Iexternals/fortran-support/build/src/mod -Iexternals/math-support/build/src/mod -Iexternals/math-interpolation/build/src/mod -DDACE_SUBST_ENABLE -g -I/scratch/wbenjami/dafy/sdfg_gpu/spack/opt/spack/linux-centos8-zen2/gcc-10.2.0/netcdf-fortran-4.6.0-p7jdeag2groulzasdfqnokx2qiris3zh/include -I/scratch/wbenjami/dafy/sdfg_gpu/spack/opt/spack/linux-centos8-zen2/gcc-10.2.0/netcdf-c-4.9.2-zynxjqlltpkunevnlaltrm7kfqlwjgpu/include  -ffree-line-length-none -DHAVE_FC_ATTRIBUTE_CONTIGUOUS -D__ICON__ -D__NO_ICON_UPATMO__ -D__NO_ICON_OCEAN__ -D__NO_JSBACH__ -D__NO_JSBACH_HD__ -D__NO_QUINCY__ -D__NO_ICON_WAVES__ -D__NO_AES__ -D__NO_RTE_RRTMGP__ -D__NO_ICON_COMIN__ -DNOMPI -D__NO_ICON_TESTBED__ -D__LOOP_EXCHANGE -DNO_MPI_CHOICE_ARG -DNO_MPI_CPTR_ARG -fopenmp
make_FCFLAGS= -I$(moddir)
ICON_FCFLAGS= -O2 -std=legacy

DEPGEN_FCFLAGS=  -D_OPENMP=201511
...
LDFLAGS= -L/scratch/pmazumde/gitspace/icon-artifacts/velocity/integrate_meh
BUNDLED_LIBFILES= externals/math-interpolation/build/src/libmath-interpolation.a externals/math-support/build/src/libmath-support.a externals/fortran-support/build/src/libfortran-support.a externals/mtime/src/.libs/libmtime.a externals/cdi/src/.libs/libcdi_f2003.a externals/cdi/src/.libs/libcdi.a 
BUNDLED_EXTRA_LIBS= $(shell $(SHELL) ./collect.extra-libs)
LIBS= -lvelocity_cpu -lopenblas -lnetcdff -lnetcdf
...
externals/cdi/Makefile: icon.mk
	$(silent_CONFIG)$(MKDIR_P) $(@D) && cd $(@D) && '/scratch/pmazumde/paper-icon-dace/icon-dace/icon-model/externals/cdi/configure'  '--enable-atmo' '--enable-les' '--disable-ecrad' '--enable-nwp' '--disable-coupling' '--disable-ocean' '--disable-rpaths' '--disable-upatmo' '--disable-jsbach' '--disable-waves' '--disable-aes' '--disable-rte-rrtmgp' '--disable-mpi-gpu' '--disable-parallel-netcdf' '--disable-cdi-pio' '--disable-yaxt' '--disable-mixed-precision' '--disable-comin' '--disable-art' '--disable-serialization' '--disable-grib2' '--disable-mpi-checks' '--disable-gpu' 'LDFLAGS=-L/scratch/pmazumde/gitspace/icon-artifacts/velocity/integrate_meh' 'LIBS=-lvelocity_cpu -lopenblas -lnetcdff -lnetcdf' 'FC=/apps/ault/spack/opt/spack/linux-centos8-zen/gcc-8.4.1/gcc-10.2.0-fqf4ze2mfclmx6e7ehrjckznpoqnevmi/bin/gfortran' 'CC=/apps/ault/spack/opt/spack/linux-centos8-zen/gcc-8.4.1/gcc-10.2.0-fqf4ze2mfclmx6e7ehrjckznpoqnevmi/bin/gcc' '--disable-option-checking' '--prefix=/usr/local' '--cache-file=/dev/null' '--srcdir=/scratch/pmazumde/paper-icon-dace/icon-dace/icon-model/externals/cdi' 'CFLAGS=-g -O2' 'FCFLAGS=-DDACE_SUBST_ENABLE -g -I/scratch/wbenjami/dafy/sdfg_gpu/spack/opt/spack/linux-centos8-zen2/gcc-10.2.0/netcdf-fortran-4.6.0-p7jdeag2groulzasdfqnokx2qiris3zh/include -I/scratch/wbenjami/dafy/sdfg_gpu/spack/opt/spack/linux-centos8-zen2/gcc-10.2.0/netcdf-c-4.9.2-zynxjqlltpkunevnlaltrm7kfqlwjgpu/include  -O2 -std=legacy' 'F77=no' 'CXX=no' 'UTIL_LINUX_UUID_C_INCLUDE=' 'UTIL_LINUX_UUID_C_LIB=' 'OSSP_UUID_C_INCLUDE=' 'OSSP_UUID_C_LIB=' 'DCE_UUID_C_INCLUDE=' 'DCE_UUID_C_LIB=' 'MPIROOT=' 'MPI_C_INCLUDE=' 'MPI_C_LIB=' 'MPI_LAUNCH=' 'MPI_FC_MOD=' 'MPI_FC_LIB=' 'PKG_CONFIG=' 'YAXT_C_INCLUDE=' 'YAXT_C_LIB=' 'YAXT_FC_MOD=' 'YAXT_FC_LIB=' 'PPM_CORE_C_INCLUDE=' 'PPM_CORE_C_LIB=' 'BUILD_CFLAGS=' 'BUILD_FCFLAGS=' 'BUILD_LDFLAGS=' 'BUILD_LIBS=' 'BUILD_MPI_C_LIB=' 'BUILD_MPI_FC_LIB=' 'BUILD_CC=' 'BUILD_CXX=' 'BUILD_FC=' 'BUILD_F77=' '--enable-silent-rules=yes' '--disable-maintainer-mode' '--enable-mpi=no' '--enable-iso-c-interface' '--enable-cf-interface=no' '--disable-ruby-interface' '--disable-python-interface' '--disable-openmp' '--disable-shared' '--enable-static' '--enable-grib' '--disable-across' '--enable-cgribex' '--disable-cdi-app' '--enable-ppm-dist-array=no' '--without-util-linux-uuid' '--without-ossp-uuid' '--without-dce-uuid' '--without-threads' '--without-fdb5' '--without-szlib' '--with-netcdf' '--with-eccodes=no' '--without-grib_api' '--with-on-demand-check-programs' '--without-example-programs' 'acx_cv_have_netcdf2=yes' 'acx_cv_have_netcdf4=yes' 'acx_cv_have_pnetcdf=no' 'acx_cv_have_libnc_dap=no' 'acx_cv_have_nc4hdf5=no' $(if $(silent_CONFIG),--silent)
...
externals/mtime/Makefile: icon.mk
	$(silent_CONFIG)$(MKDIR_P) $(@D) && cd $(@D) && '/scratch/pmazumde/paper-icon-dace/icon-dace/icon-model/externals/mtime/configure'  '--enable-atmo' '--enable-les' '--disable-ecrad' '--enable-openmp' '--enable-nwp' '--disable-mpi' '--disable-coupling' '--disable-ocean' '--disable-rpaths' '--disable-upatmo' '--disable-jsbach' '--disable-waves' '--disable-aes' '--disable-rte-rrtmgp' '--disable-mpi-gpu' '--disable-parallel-netcdf' '--disable-cdi-pio' '--disable-yaxt' '--disable-mixed-precision' '--disable-comin' '--disable-art' '--disable-serialization' '--disable-grib2' '--disable-mpi-checks' '--disable-gpu' 'LDFLAGS=-L/scratch/pmazumde/gitspace/icon-artifacts/velocity/integrate_meh' 'LIBS=-lvelocity_cpu -lopenblas -lnetcdff -lnetcdf' 'FC=/apps/ault/spack/opt/spack/linux-centos8-zen/gcc-8.4.1/gcc-10.2.0-fqf4ze2mfclmx6e7ehrjckznpoqnevmi/bin/gfortran' 'CC=/apps/ault/spack/opt/spack/linux-centos8-zen/gcc-8.4.1/gcc-10.2.0-fqf4ze2mfclmx6e7ehrjckznpoqnevmi/bin/gcc' 'CXX=/apps/ault/spack/opt/spack/linux-centos8-zen/gcc-8.4.1/gcc-10.2.0-fqf4ze2mfclmx6e7ehrjckznpoqnevmi/bin/g++' '--disable-option-checking' '--prefix=/usr/local' '--cache-file=/dev/null' '--srcdir=/scratch/pmazumde/paper-icon-dace/icon-dace/icon-model/externals/mtime' 'CFLAGS=-g -O2' 'FCFLAGS=-DDACE_SUBST_ENABLE -g -I/scratch/wbenjami/dafy/sdfg_gpu/spack/opt/spack/linux-centos8-zen2/gcc-10.2.0/netcdf-fortran-4.6.0-p7jdeag2groulzasdfqnokx2qiris3zh/include -I/scratch/wbenjami/dafy/sdfg_gpu/spack/opt/spack/linux-centos8-zen2/gcc-10.2.0/netcdf-c-4.9.2-zynxjqlltpkunevnlaltrm7kfqlwjgpu/include  -O2 -std=legacy' '--enable-silent-rules=yes' '--disable-maintainer-mode' '--enable-shared=no' '--enable-static' '--disable-examples' '--disable-fortran-hl' '--enable-python=no' '--with-pic=no' $(if $(silent_CONFIG),--silent)
...
externals/fortran-support/build/Makefile: icon.mk
	$(silent_CMAKE)$(MKDIR_P) $(@D) && cd $(@D) && "${CMAKE}"  '-Wno-dev' '--no-warn-unused-cli' '-GUnix Makefiles' '-DCMAKE_EXE_LINKER_FLAGS=-L/scratch/pmazumde/gitspace/icon-artifacts/velocity/integrate_meh' '-DCMAKE_C_STANDARD_LIBRARIES=-lvelocity_cpu -lopenblas -lnetcdff -lnetcdf' '-DCMAKE_Fortran_STANDARD_LIBRARIES=-lvelocity_cpu -lopenblas -lnetcdff -lnetcdf' '-DCMAKE_INSTALL_PREFIX=/usr/local' '/scratch/pmazumde/paper-icon-dace/icon-dace/icon-model/externals/fortran-support' '-DCMAKE_C_FLAGS=-g -O2 ' '-DCMAKE_Fortran_FLAGS=-DDACE_SUBST_ENABLE -g -I/scratch/wbenjami/dafy/sdfg_gpu/spack/opt/spack/linux-centos8-zen2/gcc-10.2.0/netcdf-fortran-4.6.0-p7jdeag2groulzasdfqnokx2qiris3zh/include -I/scratch/wbenjami/dafy/sdfg_gpu/spack/opt/spack/linux-centos8-zen2/gcc-10.2.0/netcdf-c-4.9.2-zynxjqlltpkunevnlaltrm7kfqlwjgpu/include  -O2 -std=legacy' '-DFS_ENABLE_OMP=yes' '-DFS_ENABLE_MIXED_PRECISION=no' '-DFS_ENABLE_OPENACC=OFF' '-DBUILD_SHARED_LIBS:BOOL=OFF' '-DBUILD_TESTING:BOOL=OFF' '-DCMAKE_BUILD_TYPE:STRING=NOEXTRAFLAGS' $(if $(silent_CMAKE),>/dev/null)
...
externals/math-support/build/Makefile: icon.mk
	$(silent_CMAKE)$(MKDIR_P) $(@D) && cd $(@D) && "${CMAKE}"  '-Wno-dev' '--no-warn-unused-cli' '-GUnix Makefiles' '-DCMAKE_EXE_LINKER_FLAGS=-L/scratch/pmazumde/gitspace/icon-artifacts/velocity/integrate_meh' '-DCMAKE_Fortran_STANDARD_LIBRARIES=-lvelocity_cpu -lopenblas -lnetcdff -lnetcdf' '-DCMAKE_INSTALL_PREFIX=/usr/local' '/scratch/pmazumde/paper-icon-dace/icon-dace/icon-model/externals/math-support' '-DCMAKE_Fortran_FLAGS=-DDACE_SUBST_ENABLE -g -I/scratch/wbenjami/dafy/sdfg_gpu/spack/opt/spack/linux-centos8-zen2/gcc-10.2.0/netcdf-fortran-4.6.0-p7jdeag2groulzasdfqnokx2qiris3zh/include -I/scratch/wbenjami/dafy/sdfg_gpu/spack/opt/spack/linux-centos8-zen2/gcc-10.2.0/netcdf-c-4.9.2-zynxjqlltpkunevnlaltrm7kfqlwjgpu/include  -O2 -std=legacy' '-DMS_ENABLE_LOOP_EXCHANGE=yes' '-DMS_ENABLE_MIXED_PRECISION=no' '-DMS_ENABLE_DIM_SWAP=no' '-DMS_ENABLE_OPENACC=OFF' '-DCMAKE_PREFIX_PATH:PATH=/scratch/pmazumde/paper-icon-dace/icon-dace/build/externals/fortran-support/build' '-DBUILD_SHARED_LIBS:BOOL=OFF' '-DBUILD_TESTING:BOOL=OFF' '-DBUILD_STANDALONE:BOOL=OFF' '-DCMAKE_BUILD_TYPE:STRING=NOEXTRAFLAGS' $(if $(silent_CMAKE),>/dev/null)
...
externals/math-interpolation/build/Makefile: icon.mk
	$(silent_CMAKE)$(MKDIR_P) $(@D) && cd $(@D) && "${CMAKE}"  '-Wno-dev' '--no-warn-unused-cli' '-GUnix Makefiles' '-DCMAKE_EXE_LINKER_FLAGS=-L/scratch/pmazumde/gitspace/icon-artifacts/velocity/integrate_meh' '-DCMAKE_Fortran_STANDARD_LIBRARIES=-lvelocity_cpu -lopenblas -lnetcdff -lnetcdf' '-DCMAKE_INSTALL_PREFIX=/usr/local' '/scratch/pmazumde/paper-icon-dace/icon-dace/icon-model/externals/math-interpolation' '-DCMAKE_Fortran_FLAGS=-DDACE_SUBST_ENABLE -g -I/scratch/wbenjami/dafy/sdfg_gpu/spack/opt/spack/linux-centos8-zen2/gcc-10.2.0/netcdf-fortran-4.6.0-p7jdeag2groulzasdfqnokx2qiris3zh/include -I/scratch/wbenjami/dafy/sdfg_gpu/spack/opt/spack/linux-centos8-zen2/gcc-10.2.0/netcdf-c-4.9.2-zynxjqlltpkunevnlaltrm7kfqlwjgpu/include  -O2 -std=legacy' '-DMI_ENABLE_LOOP_EXCHANGE=yes' '-DMI_ENABLE_MIXED_PRECISION=no' '-DMI_ENABLE_DIM_SWAP=no' '-DMI_ENABLE_OPENACC=OFF' '-DCMAKE_PREFIX_PATH:PATH=/scratch/pmazumde/paper-icon-dace/icon-dace/build/externals/fortran-support/build;/scratch/pmazumde/paper-icon-dace/icon-dace/build/externals/math-support/build' '-DBUILD_SHARED_LIBS:BOOL=OFF' '-DBUILD_TESTING:BOOL=OFF' '-DBUILD_STANDALONE:BOOL=OFF' '-DCMAKE_BUILD_TYPE:STRING=NOEXTRAFLAGS' $(if $(silent_CMAKE),>/dev/null)
