...
static const struct pvcs_info pvcs_infos[] = {
  // icon (/scratch/pmazumde/paper-icon-dace/icon-dace/icon-model)
  { .name = "icon",
    .revision = NULL,
    .remote_url = NULL,
    .local_branch = NULL, },
  // cdi (/scratch/pmazumde/paper-icon-dace/icon-dace/icon-model/externals/cdi)
  { .name = "cdi",
    .revision = NULL,
    .remote_url = NULL,
    .local_branch = NULL, },
  // mtime (/scratch/pmazumde/paper-icon-dace/icon-dace/icon-model/externals/mtime)
  { .name = "mtime",
    .revision = NULL,
    .remote_url = NULL,
    .local_branch = NULL, },
  // fortran-support (/scratch/pmazumde/paper-icon-dace/icon-dace/icon-model/externals/fortran-support)
  { .name = "fortran-support",
    .revision = NULL,
    .remote_url = NULL,
    .local_branch = NULL, },
  // math-support (/scratch/pmazumde/paper-icon-dace/icon-dace/icon-model/externals/math-support)
  { .name = "math-support",
    .revision = NULL,
    .remote_url = NULL,
    .local_branch = NULL, },
  // math-interpolation (/scratch/pmazumde/paper-icon-dace/icon-dace/icon-model/externals/math-interpolation)
