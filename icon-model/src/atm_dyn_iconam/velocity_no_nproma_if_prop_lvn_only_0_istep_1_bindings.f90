...
module mo_velocity_no_nproma_if_prop_lvn_only_0_istep_1_bindings
  ...
  private
  public :: run_velocity_no_nproma_if_prop_lvn_only_0_istep_1
  public :: run_velocity_no_nproma_if_prop_lvn_only_0_istep_1_verification
  public :: verify_velocity_no_nproma_if_prop_lvn_only_0_istep_1
  public :: dace_init_velocity_no_nproma_if_prop_lvn_only_0_istep_1
  public :: dace_exit_velocity_no_nproma_if_prop_lvn_only_0_istep_1
  public :: dace_program_velocity_no_nproma_if_prop_lvn_only_0_istep_1
...
interface
  ...
  type(c_ptr) function dace_init_velocity_no_nproma_if_prop_lvn_only_0_istep_1( &
    global_data, &
    p_diag, &
    p_int, &
    p_metrics, &
    ...
    f2dace_OA_z_vt_ie_d_0_s_366, &
    f2dace_OA_z_vt_ie_d_1_s_367, &
    f2dace_OA_z_vt_ie_d_2_s_368, &
    f2dace_OA_z_w_concorr_me_d_0_s_360, &
    f2dace_OA_z_w_concorr_me_d_1_s_361, &
    f2dace_OA_z_w_concorr_me_d_2_s_362, &
    clip_count, &
    dt_linintp_ubc, &
    dtime, &
    istep, &
    ...
    bind(c, name="__dace_init_velocity_no_nproma_if_prop_lvn_only_0_istep_1")
    use iso_c_binding
    ...
    integer(kind=c_int), value :: f2dace_OA_z_vt_ie_d_0_s_366
    integer(kind=c_int), value :: f2dace_OA_z_vt_ie_d_1_s_367
    integer(kind=c_int), value :: f2dace_OA_z_vt_ie_d_2_s_368
    integer(kind=c_int), value :: f2dace_OA_z_w_concorr_me_d_0_s_360
    integer(kind=c_int), value :: f2dace_OA_z_w_concorr_me_d_1_s_361
    integer(kind=c_int), value :: f2dace_OA_z_w_concorr_me_d_2_s_362
    integer(kind=c_int), value :: clip_count
  ...
  end function dace_init_velocity_no_nproma_if_prop_lvn_only_0_istep_1

  integer(c_int) function dace_exit_velocity_no_nproma_if_prop_lvn_only_0_istep_1(state) &
    bind(c, name="__dace_exit_velocity_no_nproma_if_prop_lvn_only_0_istep_1")
    use iso_c_binding

    type(c_ptr), value :: state
  end function dace_exit_velocity_no_nproma_if_prop_lvn_only_0_istep_1

  subroutine dace_program_velocity_no_nproma_if_prop_lvn_only_0_istep_1( &
    state, &
    global_data, &
    p_diag, &
    p_int, &
    ...
    integer(kind=c_int), value :: lvn_only
    integer(kind=c_int), value :: ntnd
  end subroutine dace_program_velocity_no_nproma_if_prop_lvn_only_0_istep_1
...
contains
  ...
  subroutine run_velocity_no_nproma_if_prop_lvn_only_0_istep_1( &
    p_diag, &
    p_int, &
    p_metrics, &
    p_patch, &
    ...
    if (is_initialized .eqv. .false.) then
      is_initialized = .true.
      dace_state = dace_init_velocity_no_nproma_if_prop_lvn_only_0_istep_1( &
      ...
      f2dace_OA_z_vt_ie_d_0_s_366 = lbound(z_vt_ie, dim=1), &
      f2dace_OA_z_vt_ie_d_1_s_367 = lbound(z_vt_ie, dim=2), &
      f2dace_OA_z_vt_ie_d_2_s_368 = lbound(z_vt_ie, dim=3), &
      f2dace_OA_z_w_concorr_me_d_0_s_360 = lbound(z_w_concorr_me, dim=1), &
      f2dace_OA_z_w_concorr_me_d_1_s_361 = lbound(z_w_concorr_me, dim=2), &
      f2dace_OA_z_w_concorr_me_d_2_s_362 = lbound(z_w_concorr_me, dim=3) &
    )
    end if

    call dace_program_velocity_no_nproma_if_prop_lvn_only_0_istep_1( &
      state = dace_state, &
      global_data = copy_or_ptr_global_data, &
      p_diag = copy_or_ptr_p_diag, &
      p_int = copy_or_ptr_p_int, &
  ...
  end subroutine run_velocity_no_nproma_if_prop_lvn_only_0_istep_1

  subroutine run_velocity_no_nproma_if_prop_lvn_only_0_istep_1_verification( &
    p_diag, &
    p_int, &
    p_metrics, &
    p_patch, &
  ...
  end subroutine run_velocity_no_nproma_if_prop_lvn_only_0_istep_1_verification

  subroutine verify_velocity_no_nproma_if_prop_lvn_only_0_istep_1( &
    p_diag, &
    p_int, &
    p_metrics, &
    p_patch, &
    ...
    if (is_initialized .eqv. .false.) then
      print *, "verify_velocity_no_nproma_if_prop_lvn_only_0_istep_1: dace state is not initialized"
    end if
    ...
    if (.not. result) then
      print *, "verify_velocity_no_nproma_if_prop_lvn_only_0_istep_1: Failed verification"
    else
      print *, "verify_velocity_no_nproma_if_prop_lvn_only_0_istep_1: Verification successful :)"
    end if

  end subroutine verify_velocity_no_nproma_if_prop_lvn_only_0_istep_1

end module mo_velocity_no_nproma_if_prop_lvn_only_0_istep_1_bindings
