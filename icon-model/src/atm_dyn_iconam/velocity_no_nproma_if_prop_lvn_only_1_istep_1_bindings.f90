...
module mo_velocity_no_nproma_if_prop_lvn_only_1_istep_1_bindings
  ...
  private
  public :: run_velocity_no_nproma_if_prop_lvn_only_1_istep_1
  public :: run_velocity_no_nproma_if_prop_lvn_only_1_istep_1_verification
  public :: verify_velocity_no_nproma_if_prop_lvn_only_1_istep_1
  public :: dace_init_velocity_no_nproma_if_prop_lvn_only_1_istep_1
  public :: dace_exit_velocity_no_nproma_if_prop_lvn_only_1_istep_1
  public :: dace_program_velocity_no_nproma_if_prop_lvn_only_1_istep_1
...
interface
  ...
  type(c_ptr) function dace_init_velocity_no_nproma_if_prop_lvn_only_1_istep_1( &
    global_data, &
    p_diag, &
    p_int, &
    p_metrics, &
    ...
    bind(c, name="__dace_init_velocity_no_nproma_if_prop_lvn_only_1_istep_1")
    use iso_c_binding
  ...
  end function dace_init_velocity_no_nproma_if_prop_lvn_only_1_istep_1

  integer(c_int) function dace_exit_velocity_no_nproma_if_prop_lvn_only_1_istep_1(state) &
    bind(c, name="__dace_exit_velocity_no_nproma_if_prop_lvn_only_1_istep_1")
    use iso_c_binding

    type(c_ptr), value :: state
  end function dace_exit_velocity_no_nproma_if_prop_lvn_only_1_istep_1

  subroutine dace_program_velocity_no_nproma_if_prop_lvn_only_1_istep_1( &
    state, &
    global_data, &
    p_diag, &
    p_int, &
    ...
    integer(kind=c_int), value :: lvn_only
    integer(kind=c_int), value :: ntnd
  end subroutine dace_program_velocity_no_nproma_if_prop_lvn_only_1_istep_1
...
contains
  ...
  subroutine run_velocity_no_nproma_if_prop_lvn_only_1_istep_1( &
    p_diag, &
    p_int, &
    p_metrics, &
    p_patch, &
    ...
    if (is_initialized .eqv. .false.) then
      is_initialized = .true.
      dace_state = dace_init_velocity_no_nproma_if_prop_lvn_only_1_istep_1( &
    ...
    call dace_program_velocity_no_nproma_if_prop_lvn_only_1_istep_1( &
      state = dace_state, &
      global_data = copy_or_ptr_global_data, &
      p_diag = copy_or_ptr_p_diag, &
      p_int = copy_or_ptr_p_int, &
  ...
  end subroutine run_velocity_no_nproma_if_prop_lvn_only_1_istep_1

  subroutine run_velocity_no_nproma_if_prop_lvn_only_1_istep_1_verification( &
    p_diag, &
    p_int, &
    p_metrics, &
    p_patch, &
  ...
  end subroutine run_velocity_no_nproma_if_prop_lvn_only_1_istep_1_verification

  subroutine verify_velocity_no_nproma_if_prop_lvn_only_1_istep_1( &
    p_diag, &
    p_int, &
    p_metrics, &
    p_patch, &
    ...
    if (is_initialized .eqv. .false.) then
      print *, "verify_velocity_no_nproma_if_prop_lvn_only_1_istep_1: dace state is not initialized"
    end if
    ...
    if (.not. result) then
      print *, "verify_velocity_no_nproma_if_prop_lvn_only_1_istep_1: Failed verification"
    else
      print *, "verify_velocity_no_nproma_if_prop_lvn_only_1_istep_1: Verification successful :)"
    end if

  end subroutine verify_velocity_no_nproma_if_prop_lvn_only_1_istep_1

end module mo_velocity_no_nproma_if_prop_lvn_only_1_istep_1_bindings
