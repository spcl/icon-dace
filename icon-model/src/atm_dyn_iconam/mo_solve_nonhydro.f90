...
MODULE mo_solve_nonhydro
  ...
  USE mo_solve_nh_predictor_pre_bindings, ONLY: &
    ...
    verify_solve_nh_predictor_pre, &
    run_solve_nh_predictor_pre_verification
  USE mo_solve_nh_predictor_post_bindings, ONLY: &
    run_solve_nh_predictor_post, &
    verify_solve_nh_predictor_post, &
    run_solve_nh_predictor_post_verification
  USE mo_solve_nh_corrector_pre_bindings, ONLY: &
    run_solve_nh_corrector_pre_verification, &
    run_solve_nh_corrector_pre, &
    verify_solve_nh_corrector_pre
  USE mo_solve_nh_corrector_post_bindings, ONLY: &
    verify_solve_nh_corrector_post, &
    run_solve_nh_corrector_post, &
    run_solve_nh_corrector_post_verification
#endif
...
call cpu_time(t0)
  ...
  CALL run_solve_nh_predictor_pre_verification( &
    ...
    z_rho_e = z_rho_e, &
    z_theta_v_v = z_theta_v_v, &
    z_rho_v = z_rho_v, &
    z_th_ddz_exner_c = z_th_ddz_exner_c, &
    z_dexner_dz_c = z_dexner_dz_c, &
    z_vt_ie = z_vt_ie, &
    z_kin_hor_e = z_kin_hor_e, &
    z_exner_ex_pr = z_exner_ex_pr, &
    z_gradh_exner = z_gradh_exner, &
    z_rth_pr = z_rth_pr, &
    z_grad_rth = z_grad_rth, &
    z_w_concorr_me = z_w_concorr_me, &
    z_graddiv_vn = z_graddiv_vn, &
    z_w_expl = z_w_expl, &
    z_vn_avg = z_vn_avg, &
    z_mflx_top = z_mflx_top, &
...
#else
  !PRINT *, "Enter solve_nh_predictor_pre"
  CALL run_solve_nh_predictor_pre( &
    p_nh = p_nh, &
    p_nh_prog_nnow = p_nh % prog(nnow), &
    p_nh_prog_nnew = p_nh % prog(nnew), &
    p_patch = p_patch, &
...
#else
  !PRINT *, "Enter solve_nh_predictor_post"
  CALL run_solve_nh_predictor_post( &
    p_nh = p_nh, &
    p_nh_prog_nnow = p_nh % prog(nnow), &
    p_nh_prog_nnew = p_nh % prog(nnew), &
    p_patch = p_patch, &
...
print *, 'PREPOST (s): ', (t1-t0)
    ...
    ! end `DO istep = 1, 2` unrolled with `istep == 1`
...
#else
  !PRINT *, "Enter solve_nh_corrector_pre"
  CALL run_solve_nh_corrector_pre( &
    p_nh = p_nh, &
    p_nh_prog_nnow = p_nh % prog(nnow), &
    p_nh_prog_nnew = p_nh % prog(nnew), &
    p_patch = p_patch, &
...
#else
  !PRINT *, "Enter solve_nh_corrector_post"
  CALL run_solve_nh_corrector_post( &
    p_nh = p_nh, &
    p_nh_prog_nnow = p_nh % prog(nnow), &
    p_nh_prog_nnew = p_nh % prog(nnew), &
    p_patch = p_patch, &
...
print *, 'CORPOST (s): ', (t1-t0)
    ...
    ! end `DO istep = 1, 2` unrolled with `istep == 2`
