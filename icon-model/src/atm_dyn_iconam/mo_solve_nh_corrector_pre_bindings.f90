...
module mo_solve_nh_corrector_pre_bindings
  ...
  private
  public :: run_solve_nh_corrector_pre
  public :: run_solve_nh_corrector_pre_verification
  public :: verify_solve_nh_corrector_pre
  public :: dace_init_solve_nh_corrector_pre
  public :: dace_exit_solve_nh_corrector_pre
  public :: dace_program_solve_nh_corrector_pre
...
interface
  ...
  type(c_ptr) function dace_init_solve_nh_corrector_pre( &
    bdy_divdamp, &
    enh_divdamp_fac, &
    global_data, &
    p_int, &
    ...
    bind(c, name="__dace_init_solve_nh_corrector_pre")
    use iso_c_binding
  ...
  end function dace_init_solve_nh_corrector_pre

  integer(c_int) function dace_exit_solve_nh_corrector_pre(state) &
    bind(c, name="__dace_exit_solve_nh_corrector_pre")
    use iso_c_binding

    type(c_ptr), value :: state
  end function dace_exit_solve_nh_corrector_pre

  subroutine dace_program_solve_nh_corrector_pre( &
    state, &
    bdy_divdamp, &
    enh_divdamp_fac, &
    global_data, &
    ...
    bind(c, name="__program_solve_nh_corrector_pre")
    use iso_c_binding
    ...
    real(kind=c_double), value :: z_w_backtraj
    real(kind=c_double), value :: zf
  end subroutine dace_program_solve_nh_corrector_pre
...
contains
  ...
  function copy_in_global_data_type(steal_arrays, minimal_structs) result(dace_obj_ptr)
    ...
    dace_rich_obj%divdamp_fac = divdamp_fac
    dace_rich_obj%divdamp_fac_o2 = divdamp_fac_o2
    dace_rich_obj%divdamp_order = divdamp_order
  ...
  subroutine copy_back_global_data_type(dace_obj_ptr)
    ...
    divdamp_fac = dace_rich_obj%divdamp_fac
    divdamp_fac_o2 = dace_rich_obj%divdamp_fac_o2
    divdamp_order = transfer(dace_rich_obj%divdamp_order, mold=divdamp_order)
  ...
  subroutine compare_global_data_type_struct( &
    ...
    call compare_float64_scalar( &
      actual=actual_rich%divdamp_fac, &
      ref=divdamp_fac, &
      result=local_result, &
      scalar_expr=member_expr &
    )
    ...
    call compare_float64_scalar( &
      actual=actual_rich%divdamp_fac_o2, &
      ref=divdamp_fac_o2, &
      result=local_result, &
      scalar_expr=member_expr &
    )
    ...
    call compare_int32_scalar( &
      actual=actual_rich%divdamp_order, &
      ref=transfer(divdamp_order, mold=int(1, kind=4)), &
      result=local_result, &
      scalar_expr=member_expr &
    )
  ...
  subroutine run_solve_nh_corrector_pre( &
    bdy_divdamp, &
    enh_divdamp_fac, &
    p_int, &
    p_nh, &
...
real :: t0, t1
    ...
    if (is_initialized .eqv. .false.) then
      is_initialized = .true.
      dace_state = dace_init_solve_nh_corrector_pre( &
...
call cpu_time(t0)
    ...
    call dace_program_solve_nh_corrector_pre( &
      state = dace_state, &
      bdy_divdamp = copy_or_ptr_bdy_divdamp, &
      enh_divdamp_fac = copy_or_ptr_enh_divdamp_fac, &
      global_data = copy_or_ptr_global_data, &
...
print *, 'CORPRE INTERNAL (s): ', (t1-t0)
  ...
  end subroutine run_solve_nh_corrector_pre

  subroutine run_solve_nh_corrector_pre_verification( &
    bdy_divdamp, &
    enh_divdamp_fac, &
    p_int, &
    p_nh, &
  ...
  end subroutine run_solve_nh_corrector_pre_verification

  subroutine verify_solve_nh_corrector_pre( &
    bdy_divdamp, &
    enh_divdamp_fac, &
    p_int, &
    p_nh, &
    ...
    if (is_initialized .eqv. .false.) then
      print *, "verify_solve_nh_corrector_pre: dace state is not initialized"
    end if
    ...
    if (.not. result) then
      print *, "verify_solve_nh_corrector_pre: Failed verification"
    else
      print *, "verify_solve_nh_corrector_pre: Verification successful :)"
    end if

  end subroutine verify_solve_nh_corrector_pre

end module mo_solve_nh_corrector_pre_bindings
