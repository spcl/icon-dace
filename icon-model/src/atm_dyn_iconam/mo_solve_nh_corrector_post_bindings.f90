...
module mo_solve_nh_corrector_post_bindings
  ...
  private
  public :: run_solve_nh_corrector_post
  public :: run_solve_nh_corrector_post_verification
  public :: verify_solve_nh_corrector_post
  public :: dace_init_solve_nh_corrector_post
  public :: dace_exit_solve_nh_corrector_post
  public :: dace_program_solve_nh_corrector_post
...
interface
  ...
  type(c_ptr) function dace_init_solve_nh_corrector_post( &
    bdy_divdamp, &
    enh_divdamp_fac, &
    global_data, &
    p_int, &
    ...
    bind(c, name="__dace_init_solve_nh_corrector_post")
    use iso_c_binding
  ...
  end function dace_init_solve_nh_corrector_post

  integer(c_int) function dace_exit_solve_nh_corrector_post(state) &
    bind(c, name="__dace_exit_solve_nh_corrector_post")
    use iso_c_binding

    type(c_ptr), value :: state
  end function dace_exit_solve_nh_corrector_post

  subroutine dace_program_solve_nh_corrector_post( &
    state, &
    bdy_divdamp, &
    enh_divdamp_fac, &
    global_data, &
    ...
    bind(c, name="__program_solve_nh_corrector_post")
    use iso_c_binding
    ...
    real(kind=c_double), value :: z_w_backtraj
    real(kind=c_double), value :: zf
  end subroutine dace_program_solve_nh_corrector_post
...
contains
  ...
  subroutine run_solve_nh_corrector_post( &
    bdy_divdamp, &
    enh_divdamp_fac, &
    p_int, &
    p_nh, &
...
real :: t0, t1
    ...
    if (is_initialized .eqv. .false.) then
      is_initialized = .true.
      dace_state = dace_init_solve_nh_corrector_post( &
...
call cpu_time(t0)
    ...
    call dace_program_solve_nh_corrector_post( &
      state = dace_state, &
      bdy_divdamp = copy_or_ptr_bdy_divdamp, &
      enh_divdamp_fac = copy_or_ptr_enh_divdamp_fac, &
      global_data = copy_or_ptr_global_data, &
...
! SOLVE_NH PART TIMERS : PRATYAI
call cpu_time(t1)
print *, 'CORPOST INTERNAL (s): ', (t1-t0)
  ...
  end subroutine run_solve_nh_corrector_post

  subroutine run_solve_nh_corrector_post_verification( &
    bdy_divdamp, &
    enh_divdamp_fac, &
    p_int, &
    p_nh, &
  ...
  end subroutine run_solve_nh_corrector_post_verification

  subroutine verify_solve_nh_corrector_post( &
    bdy_divdamp, &
    enh_divdamp_fac, &
    p_int, &
    p_nh, &
    ...
    if (is_initialized .eqv. .false.) then
      print *, "verify_solve_nh_corrector_post: dace state is not initialized"
    end if
    ...
    if (.not. result) then
      print *, "verify_solve_nh_corrector_post: Failed verification"
    else
      print *, "verify_solve_nh_corrector_post: Verification successful :)"
    end if

  end subroutine verify_solve_nh_corrector_post

end module mo_solve_nh_corrector_post_bindings
