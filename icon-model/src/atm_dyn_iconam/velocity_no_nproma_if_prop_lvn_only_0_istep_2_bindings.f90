...
module mo_velocity_no_nproma_if_prop_lvn_only_0_istep_2_bindings
  ...
  private
  public :: run_velocity_no_nproma_if_prop_lvn_only_0_istep_2
  public :: run_velocity_no_nproma_if_prop_lvn_only_0_istep_2_verification
  public :: verify_velocity_no_nproma_if_prop_lvn_only_0_istep_2
  public :: dace_init_velocity_no_nproma_if_prop_lvn_only_0_istep_2
  public :: dace_exit_velocity_no_nproma_if_prop_lvn_only_0_istep_2
  public :: dace_program_velocity_no_nproma_if_prop_lvn_only_0_istep_2
...
interface
  ...
  type(c_ptr) function dace_init_velocity_no_nproma_if_prop_lvn_only_0_istep_2( &
    global_data, &
    p_diag, &
    p_int, &
    p_metrics, &
    ...
    bind(c, name="__dace_init_velocity_no_nproma_if_prop_lvn_only_0_istep_2")
    use iso_c_binding
  ...
  end function dace_init_velocity_no_nproma_if_prop_lvn_only_0_istep_2

  integer(c_int) function dace_exit_velocity_no_nproma_if_prop_lvn_only_0_istep_2(state) &
    bind(c, name="__dace_exit_velocity_no_nproma_if_prop_lvn_only_0_istep_2")
    use iso_c_binding

    type(c_ptr), value :: state
  end function dace_exit_velocity_no_nproma_if_prop_lvn_only_0_istep_2

  subroutine dace_program_velocity_no_nproma_if_prop_lvn_only_0_istep_2( &
    state, &
    global_data, &
    p_diag, &
    p_int, &
    ...
    integer(kind=c_int), value :: lvn_only
    integer(kind=c_int), value :: ntnd
  end subroutine dace_program_velocity_no_nproma_if_prop_lvn_only_0_istep_2
...
contains
  ...
  subroutine run_velocity_no_nproma_if_prop_lvn_only_0_istep_2( &
    p_diag, &
    p_int, &
    p_metrics, &
    p_patch, &
    ...
    if (is_initialized .eqv. .false.) then
      is_initialized = .true.
      dace_state = dace_init_velocity_no_nproma_if_prop_lvn_only_0_istep_2( &
    ...
    call dace_program_velocity_no_nproma_if_prop_lvn_only_0_istep_2( &
      state = dace_state, &
      global_data = copy_or_ptr_global_data, &
      p_diag = copy_or_ptr_p_diag, &
      p_int = copy_or_ptr_p_int, &
  ...
  end subroutine run_velocity_no_nproma_if_prop_lvn_only_0_istep_2

  subroutine run_velocity_no_nproma_if_prop_lvn_only_0_istep_2_verification( &
    p_diag, &
    p_int, &
    p_metrics, &
    p_patch, &
  ...
  end subroutine run_velocity_no_nproma_if_prop_lvn_only_0_istep_2_verification

  subroutine verify_velocity_no_nproma_if_prop_lvn_only_0_istep_2( &
    p_diag, &
    p_int, &
    p_metrics, &
    p_patch, &
    ...
    if (is_initialized .eqv. .false.) then
      print *, "verify_velocity_no_nproma_if_prop_lvn_only_0_istep_2: dace state is not initialized"
    end if
    ...
    if (.not. result) then
      print *, "verify_velocity_no_nproma_if_prop_lvn_only_0_istep_2: Failed verification"
    else
      print *, "verify_velocity_no_nproma_if_prop_lvn_only_0_istep_2: Verification successful :)"
    end if

  end subroutine verify_velocity_no_nproma_if_prop_lvn_only_0_istep_2

end module mo_velocity_no_nproma_if_prop_lvn_only_0_istep_2_bindings
