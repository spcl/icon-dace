# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/sppt/mo_sppt_util.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 17 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/sppt/mo_sppt_util.f90" 2
!----------------------------
