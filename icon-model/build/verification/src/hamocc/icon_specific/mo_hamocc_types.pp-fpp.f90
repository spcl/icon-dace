# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/hamocc/icon_specific/mo_hamocc_types.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
!---------------------
! Upper-lower case
# 15 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/hamocc/icon_specific/mo_hamocc_types.f90" 2
