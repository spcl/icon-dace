# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/shr_horizontal/mo_math_divrot.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 20 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/shr_horizontal/mo_math_divrot.f90" 2
!----------------------------
...
# 249 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/shr_horizontal/mo_math_divrot.f90"
...
# 489 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/shr_horizontal/mo_math_divrot.f90"
    !$ACC PARALLEL DEFAULT(PRESENT) ASYNC(1) IF(i_am_accel_node)
...
# 1502 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/shr_horizontal/mo_math_divrot.f90"
    !$ACC PARALLEL DEFAULT(PRESENT) ASYNC(1) IF(i_am_accel_node)
