# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/shr_horizontal/mo_delaunay.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
!$omp          reduction(min:jmin_t)
      ...
      jmin    = ntri
# 567 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/shr_horizontal/mo_delaunay.f90"
...
# 901 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/shr_horizontal/mo_delaunay.f90"
