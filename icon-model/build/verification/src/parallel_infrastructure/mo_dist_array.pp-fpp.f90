# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_dist_array.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 3257 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_dist_array.f90"
...
CONTAINS
  ...
  SUBROUTINE dist_mult_array_get_i4(dm_array, sub_array, coord, v)
    ...
    CALL assertion(dm_array%exposure_status == exposed, &
         "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_dist_array.f90", &
