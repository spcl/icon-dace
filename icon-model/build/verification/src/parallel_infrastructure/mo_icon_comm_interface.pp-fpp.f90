# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_icon_comm_interface.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
!      & for_patch%work_communicator
    ! CALL  flush(0)
# 107 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_icon_comm_interface.f90"
    RETURN
