# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_sync.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 17 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_sync.f90" 2
!----------------------------
MODULE mo_sync
!-------------------------------------------------------------------------
!
...
# 914 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_sync.f90"
     IF(l_log_checks) THEN
       CLOSE (log_unit)
     ENDIF
