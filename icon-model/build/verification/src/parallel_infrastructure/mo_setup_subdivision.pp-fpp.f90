# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
MODULE mo_setup_subdivision
  ...
  USE ppm_distributed_array,  ONLY: dist_mult_array, global_array_desc, &
    ...
    &                               dist_mult_array_get, &
    &                               ppm_int
# 114 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
...
# 998 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
...
# 1270 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
...
# 1397 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
...
# 1504 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
...
# 1563 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
    ENDDO
...
# 1594 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
...
# 2243 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
  ...
  !    IF (n_boundary_rows > 0 .AND. order_type_of_halos /= 0) THEN
      ...
      DO ilev = 1, n_boundary_rows
        ...
        IF (SIZE(temp_cells(:)) < n_temp_edges) THEN
          ...
          ALLOCATE(temp_cells(n_temp_edges))
        END IF
# 2459 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
...
# 2516 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
        ...
        END IF
        n_temp_cells = 0
# 2597 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
...
# 2658 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
        ...
        n_temp_edges = 0
        DO k = -1, 0
# 2748 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
        ...
        n_temp_vertices = 0
        DO k = -1, 0
# 2907 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
...
# 3207 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
...
# 3335 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
  ...
  SUBROUTINE build_patch_start_end(n_patch_cve, n_patch_cve_g, &
    ...
    CASE (1)
      ...
      jf = 1
      j = 0
# 3510 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
...
# 3649 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
        DO j = 1, n2_ilev(ilev)
...
# 4248 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
...
# 4361 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
...
# 4475 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
      DO j = range_start, range_end
...
# 4711 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
...
# 5013 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
  !-------------------------------------------------------------------------
...
# 5153 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_setup_subdivision.f90"
