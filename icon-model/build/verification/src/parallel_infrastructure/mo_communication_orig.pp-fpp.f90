# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 24 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90" 2
...
!
# 25 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90" 2
!----------------------------
...
# 505 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
  ...
  SUBROUTINE exchange_data_r3d(p_pat, lacc, recv, send, add)
    ...
    IF (ndim2 == 1) THEN
      ...
      !$ACC END PARALLEL
    ELSE
# 1058 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
      DO i = 1, p_pat%n_send
    ...
    IF(PRESENT(add)) THEN
      IF (ndim2 == 1) THEN
        ...
        !$ACC END PARALLEL
      ELSE
# 1150 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
        DO i = 1, p_pat%n_pnts
    ...
    ELSE
      IF (ndim2 == 1) THEN
        ...
        !$ACC END PARALLEL
      ELSE
# 1183 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
        DO i = 1, p_pat%n_pnts
  ...
  SUBROUTINE exchange_data_s3d(p_pat, lacc, recv, send, add)
    ...
    IF (ndim2 == 1) THEN
      ...
      !$ACC END PARALLEL
    ELSE
# 1314 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
      DO i = 1, p_pat%n_send
        send_buf(1:ndim2,i) = send_ptr(p_pat%send_src_idx(i),1:ndim2, p_pat%send_src_blk(i))
      ENDDO
    ...
    IF(PRESENT(add)) THEN
      IF (ndim2 == 1) THEN
        ...
        !$ACC END PARALLEL
      ELSE
# 1407 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
        DO i = 1, p_pat%n_pnts
          recv(p_pat%recv_dst_idx(i),:,p_pat%recv_dst_blk(i)) = &
            recv_buf(:,p_pat%recv_src(i)) + add(p_pat%recv_dst_idx(i),1:ndim2,p_pat%recv_dst_blk(i))
        ENDDO
    ...
    ELSE
      IF (ndim2 == 1) THEN
        ...
        !$ACC END PARALLEL
      ELSE
# 1440 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
        DO i = 1, p_pat%n_pnts
          recv(p_pat%recv_dst_idx(i),:,p_pat%recv_dst_blk(i)) = recv_buf(:,p_pat%recv_src(i))
        ENDDO
...
!recv may or may not already be on the gpu
    ...
    IF (ndim2 == 1) THEN
      ...
      !$ACC END PARALLEL
    ELSE
# 1766 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
      DO i = 1, p_pat%n_send
    ...
    IF(PRESENT(add)) THEN
      IF (ndim2 == 1) THEN
        ...
        !$ACC END PARALLEL
      ELSE
# 1856 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
        DO i = 1, p_pat%n_pnts
    ...
    ELSE
      IF (ndim2 == 1) THEN
        ...
        !$ACC END PARALLEL
      ELSE
# 1889 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
        DO i = 1, p_pat%n_pnts
  ...
  SUBROUTINE exchange_data_l3d(p_pat, lacc, recv, send)
    ...
    IF (ndim2 == 1) THEN
      ...
      !$ACC END PARALLEL
    ELSE
# 2108 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
      DO i = 1, p_pat%n_send
        send_buf(1:ndim2,i) = send_ptr(send_src_idx(i),1:ndim2, send_src_blk(i))
      ENDDO
    ...
    IF (ndim2 == 1) THEN
      ...
      !$ACC END PARALLEL
    ELSE
# 2195 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
        DO i = 1, p_pat%n_pnts
          recv(recv_dst_idx(i),:,recv_dst_blk(i)) = recv_buf(:,recv_src(i))
        ENDDO
  ...
  SUBROUTINE exchange_data_mult(p_pat, lacc, ndim2tot, &
    ...
    TYPE(t_ptr_3d), OPTIONAL, INTENT(in) :: send(:)
...
# 2300 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
    ...
    ! Set up send buffer
# 2374 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
    DO i = 1, n_send
...
# 2475 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
    DO i = 1, n_pnts
...
# 2526 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
...
# 2620 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
    !$ACC DATA CREATE(send_buf_dp, recv_buf_dp, send_buf_sp, recv_buf_sp) &
    !$ACC   PRESENT(recv_src, recv_dst_blk, recv_dst_idx, send_src_blk, send_src_idx) &
    !$ACC   ASYNC(get_comm_acc_queue()) IF(lzacc)


# 2637 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
    ...
    ! Set up send buffer
# 2751 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
    DO i = 1, n_send
      jb = send_src_blk(i)
      jl = send_src_idx(i)
      IF ( lsend ) THEN
...
# 2886 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
    DO i = 1, n_pnts
      jb = recv_dst_blk(i)
      jl = recv_dst_idx(i)
      ik  = recv_src(i)
...
# 3042 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
    !$ACC PARALLEL DEFAULT(PRESENT) ASYNC(1) IF(lzacc)
    !$ACC LOOP GANG
    DO i = 1, n_send
      jb = send_src_blk(i)
    ...
    ! Fill in receive buffer
# 3141 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
    !$ACC PARALLEL DEFAULT(PRESENT) ASYNC(1) IF(lzacc)
    !$ACC LOOP GANG
    DO i = 1, n_pnts
      jb = recv_dst_blk(i)
...
# 3353 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
    ...
    ELSE    ! WS: removed RETURN statement to allow for OpenACC DATA region
      ...
      ! Set up send buffer
# 3427 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
      DO np = 1, npats
...
# 3646 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
      DO np = 1, npats
...
# 3684 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/parallel_infrastructure/mo_communication_orig.f90"
