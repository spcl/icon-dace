# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/sea_ice/dynamics_fem/mo_ice_new_dynamics.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
!      CALL dbg_print('start 0.3 vn', p_ice%vn_e ,str_module, 2, in_subset=patch_2D%edges%owned)
    ...
    !**************************************************************
        ...
        !**************************************************************                                                                                                               
# 329 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/sea_ice/dynamics_fem/mo_ice_new_dynamics.f90"
