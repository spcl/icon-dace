# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_velocity_advection.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 18 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_velocity_advection.f90" 2
!----------------------------
...
# 377 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_velocity_advection.f90"
...
!$OMP DO PRIVATE(jb, jk, je, i_startidx, i_endidx) ICON_OMP_DEFAULT_SCHEDULE
      DO jb = i_startblk, i_endblk
        ...
        !$ACC PARALLEL DEFAULT(PRESENT) ASYNC(1)
        !$ACC LOOP GANG VECTOR TILE(32, 4)
# 411 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_velocity_advection.f90"
!$NEC outerloop_unroll(2)
        DO jk = 1, nlev
          DO je = i_startidx, i_endidx
...
!DIR$ IVDEP
      ...
      !$ACC LOOP GANG(STATIC: 1) VECTOR TILE(32, 4)
# 634 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_velocity_advection.f90"
!$NEC outerloop_unroll(4)
      DO jk = 2, nlev
        DO jc = i_startidx_2, i_endidx_2
...
!$OMP DO PRIVATE(jb, jk, je, i_startidx, i_endidx, ie, w_con_e, difcoef) ICON_OMP_DEFAULT_SCHEDULE
    DO jb = i_startblk, i_endblk
      ...
      IF (.NOT. ldeepatmo) THEN
        !$ACC PARALLEL DEFAULT(PRESENT) ASYNC(1)
        !$ACC LOOP GANG VECTOR TILE(32, 4)
# 723 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_velocity_advection.f90"
!$NEC outerloop_unroll(3)
      ...
      ELSE
        ...
        !$ACC PARALLEL DEFAULT(PRESENT) ASYNC(1)
        !$ACC LOOP GANG VECTOR TILE(32, 4)
# 791 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_velocity_advection.f90"
!$NEC outerloop_unroll(3)
        DO jk = 1, nlev
          DO je = i_startidx, i_endidx
...
# 976 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_velocity_advection.f90"
