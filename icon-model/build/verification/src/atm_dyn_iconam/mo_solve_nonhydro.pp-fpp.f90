# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_solve_nonhydro.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 18 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_solve_nonhydro.f90" 2
!----------------------------
...
# 153 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_solve_nonhydro.f90"
...
# 231 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_solve_nonhydro.f90"
...
# 494 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_solve_nonhydro.f90"
...
!DIR$ IVDEP
          ...
          !$ACC PARALLEL DEFAULT(PRESENT) ASYNC(1)
# 621 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_solve_nonhydro.f90"
          !$ACC LOOP GANG VECTOR
          DO jc = i_startidx, i_endidx
...
# 660 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_solve_nonhydro.f90"
...
# 698 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_solve_nonhydro.f90"
...
# 985 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_solve_nonhydro.f90"
...
!$OMP DO PRIVATE(jb,jk,je,i_startidx,i_endidx) ICON_OMP_DEFAULT_SCHEDULE
        DO jb = i_startblk, i_endblk
          ...
          !$ACC PARALLEL DEFAULT(PRESENT) ASYNC(1)
          !$ACC LOOP GANG VECTOR COLLAPSE(2)
# 1068 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_solve_nonhydro.f90"
...
# 1183 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_solve_nonhydro.f90"
...
!DIR$ IVDEP
        ...
        IF (istep == 2) THEN
          ...
          ! Compute gradient of divergence of gradient of divergence for fourth-order divergence damping
            !$ACC LOOP GANG(STATIC: 1) VECTOR TILE(32, 4)
# 1420 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_solve_nonhydro.f90"
...
!DIR$ IVDEP
            ...
            ENDIF
          ENDDO
# 1813 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_solve_nonhydro.f90"
        ENDIF
...
# 2040 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_solve_nonhydro.f90"
!
! OMP-only code
!
...
# 2872 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_solve_nonhydro.f90"
        !$ACC LOOP GANG VECTOR TILE(32, 4)
        DO jk = 1, nlev
          DO jc = i_startidx, i_endidx
...
# 3149 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_dyn_iconam/mo_solve_nonhydro.f90"
