# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/ocean/math/mo_ocean_math_operators.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 16 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/ocean/math/mo_ocean_math_operators.f90" 2
...
# 17 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/ocean/math/mo_ocean_math_operators.f90" 2

# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/include/iconfor_dsl_definitions.inc" 1
! ICON
!
! ---------------------------------------------------------------
! Copyright (C) 2004-2024, DWD, MPI-M, DKRZ, KIT, ETH, MeteoSwiss
...
!---------------------
! Upper-lower case
# 18 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/ocean/math/mo_ocean_math_operators.f90" 2
...
!
# 19 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/ocean/math/mo_ocean_math_operators.f90" 2
!=============================================================================================
!----------------------------
...
!ICON_OMP edgeOfVertex_index, edgeOfVertex_block, level) ICON_OMP_DEFAULT_SCHEDULE
    DO blockNo = verts_in_domain%start_block, verts_in_domain%end_block
      ...
      !$ACC END KERNELS
# 150 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/ocean/math/mo_ocean_math_operators.f90"
...
# 481 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/ocean/math/mo_ocean_math_operators.f90"
...
# 1453 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/ocean/math/mo_ocean_math_operators.f90"
      ...
      DO blockNo = all_cells%start_block, all_cells%end_block
        ...
        DO jc = cell_StartIndex, cell_EndIndex
          IF ( patch_3D%p_patch_1d(1)%dolic_c(jc,blockNo) > 0 ) THEN
            ...
            patch_3D%p_patch_1d(1)%depth_cellmiddle(jc,1,blockNo) = cell_thickness(jc,1,blockNo) * 0.5_wp
            patch_3D%p_patch_1d(1)%depth_cellinterface(jc,2,blockNo) = cell_thickness(jc,1,blockNo)
# 2307 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/ocean/math/mo_ocean_math_operators.f90"
            !$ACC LOOP SEQ
            DO level=2, patch_3D%p_patch_1d(1)%dolic_c(jc,blockNo)
...
# 3157 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/ocean/math/mo_ocean_math_operators.f90"
  !-------------------------------------------------------------------------
