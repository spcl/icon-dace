# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/ocean/math/mo_scalar_product.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 21 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/ocean/math/mo_scalar_product.f90" 2
...
# 22 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/ocean/math/mo_scalar_product.f90" 2
!----------------------------
...
# 1919 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/ocean/math/mo_scalar_product.f90"
      !$ACC PARALLEL DEFAULT(PRESENT) ASYNC(1) IF(lzacc)
      !$ACC LOOP GANG VECTOR
      DO je =  start_edge_index, end_edge_index
