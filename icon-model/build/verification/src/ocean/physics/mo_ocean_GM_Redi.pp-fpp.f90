# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/ocean/physics/mo_ocean_GM_Redi.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 16 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/ocean/physics/mo_ocean_GM_Redi.f90" 2
...
!---------------------
! Upper-lower case
# 17 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/ocean/physics/mo_ocean_GM_Redi.f90" 2
!=============================================================================================
    ...
    DO blockNo = cells_in_domain%start_block, cells_in_domain%end_block
      ...
      DO cell_index = start_cell_index, end_cell_index
        ...
        IF(patch_3D%p_patch_1D(1)%dolic_c(cell_index,blockNo)>=start_level)THEN
          ...
          flux_vert_center(cell_index,start_level,blockNo) = 0.0_wp
        ENDIF
# 2804 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/ocean/physics/mo_ocean_GM_Redi.f90"
       DO level = start_level+1, patch_3D%p_patch_1D(1)%dolic_c(cell_index,blockNo)
