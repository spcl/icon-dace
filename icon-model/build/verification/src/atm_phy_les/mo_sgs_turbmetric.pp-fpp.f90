# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_phy_les/mo_sgs_turbmetric.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 17 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_phy_les/mo_sgs_turbmetric.f90" 2
!----------------------------
...
# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_phy_les/smagorinsky_strain_rate.inc" 1
! ICON
!
! ---------------------------------------------------------------
! Copyright (C) 2004-2024, DWD, MPI-M, DKRZ, KIT, ETH, MeteoSwiss
...
# 452 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_phy_les/mo_sgs_turbmetric.f90" 2
...
!diffusion: D_11-1/3*(D_11+D_22+D_33)
div_of_stress(je,jk,jb)  = 0.5_wp * ( D_11 + D_22 + D_33 )
# 483 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_phy_les/mo_sgs_turbmetric.f90" 2
          D_11_ie(je,jk+1,jb) = p_nh_metrics%wgtfac_e(je,jk+1,jb) * D_11
          D_12_ie(je,jk+1,jb) = p_nh_metrics%wgtfac_e(je,jk+1,jb) * D_12
          D_13_ie(je,jk+1,jb) = p_nh_metrics%wgtfac_e(je,jk+1,jb) * D_13
          D_11_ie(je,jk,jb)   = D_11_ie(je,jk,jb) +                                               &
...
!diffusion: D_11-1/3*(D_11+D_22+D_33)
div_of_stress(je,jk,jb)  = 0.5_wp * ( D_11 + D_22 + D_33 )
# 509 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_phy_les/mo_sgs_turbmetric.f90" 2
          IF (jk <= nlev-1) THEN
            D_11_ie(je,jk+1,jb) = p_nh_metrics%wgtfac_e(je,jk+1,jb) * D_11
            D_12_ie(je,jk+1,jb) = p_nh_metrics%wgtfac_e(je,jk+1,jb) * D_12
            D_13_ie(je,jk+1,jb) = p_nh_metrics%wgtfac_e(je,jk+1,jb) * D_13
...
!diffusion: D_11-1/3*(D_11+D_22+D_33)
div_of_stress(je,jk,jb)  = 0.5_wp * ( D_11 + D_22 + D_33 )
# 940 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_phy_les/mo_sgs_turbmetric.f90" 2
          D_11_ie(je,1,jb)    = D_11_ie(je,1,jb) + p_nh_metrics%wgtfacq1_e(je,jk,jb) * D_11
          D_12_ie(je,1,jb)    = D_12_ie(je,1,jb) + p_nh_metrics%wgtfacq1_e(je,jk,jb) * D_12
          D_13_ie(je,1,jb)    = D_13_ie(je,1,jb) + p_nh_metrics%wgtfacq1_e(je,jk,jb) * D_13
          D_11_ie(je,jk+1,jb) = p_nh_metrics%wgtfac_e(je,jk+1,jb) * D_11
...
!diffusion: D_11-1/3*(D_11+D_22+D_33)
div_of_stress(je,jk,jb)  = 0.5_wp * ( D_11 + D_22 + D_33 )
# 965 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_phy_les/mo_sgs_turbmetric.f90" 2
          D_11_ie(je,jk+1,jb) = p_nh_metrics%wgtfac_e(je,jk+1,jb) * D_11
          D_12_ie(je,jk+1,jb) = p_nh_metrics%wgtfac_e(je,jk+1,jb) * D_12
          D_13_ie(je,jk+1,jb) = p_nh_metrics%wgtfac_e(je,jk+1,jb) * D_13
          D_11_ie(je,jk,jb)   = D_11_ie(je,jk,jb) +                                               &
...
!diffusion: D_11-1/3*(D_11+D_22+D_33)
div_of_stress(je,jk,jb)  = 0.5_wp * ( D_11 + D_22 + D_33 )
# 984 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/atm_phy_les/mo_sgs_turbmetric.f90" 2
          IF (jk <= nlev-1) THEN
            D_11_ie(je,jk+1,jb) = p_nh_metrics%wgtfac_e(je,jk+1,jb) * D_11
            D_12_ie(je,jk+1,jb) = p_nh_metrics%wgtfac_e(je,jk+1,jb) * D_12
            D_13_ie(je,jk+1,jb) = p_nh_metrics%wgtfac_e(je,jk+1,jb) * D_13
