# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/advection/mo_advection_hflux.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 37 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/advection/mo_advection_hflux.f90" 2
!----------------------------
   ...
   !-------------------------------------------------------------------------
    ...
    IF ( ld_compute ) THEN
      ...
      ALLOCATE( z_quad_vector_sum0(nproma,dim_unk,nlev,p_patch%nblks_e), &
        ...
        &       STAT=ist )
# 2780 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/advection/mo_advection_hflux.f90"
      IF (ist /= SUCCESS) THEN
        CALL finish(routine,                                      &
