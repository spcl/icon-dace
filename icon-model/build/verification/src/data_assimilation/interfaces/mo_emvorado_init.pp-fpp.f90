# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/data_assimilation/interfaces/mo_emvorado_init.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 70 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/data_assimilation/interfaces/mo_emvorado_init.f90"
    ierror = 0
