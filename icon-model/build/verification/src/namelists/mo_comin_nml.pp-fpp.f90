# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/namelists/mo_comin_nml.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
CONTAINS
  ...
  SUBROUTINE read_comin_namelist( filename )
    ...
    !
# 132 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/namelists/mo_comin_nml.f90"
