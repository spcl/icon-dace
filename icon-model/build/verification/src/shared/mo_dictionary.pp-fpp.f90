# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/shared/mo_dictionary.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
! Hence, for older cray compiler versions, the following code circumvents this bug.
! This can be removed when recent cray compiler versions are available at ECMWF's Cray
# 178 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/shared/mo_dictionary.f90"
      key => line(1:klen-1)
