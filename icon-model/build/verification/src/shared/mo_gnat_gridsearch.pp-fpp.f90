# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/shared/mo_gnat_gridsearch.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
!$OMP END PARALLEL
  ...
  SUBROUTINE gnat_query_containing_triangles(gnat, p_patch, v, iv_nproma, iv_nblks,       &
    ...
    radius = p_max(radius, comm=p_comm_work)
# 1557 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/shared/mo_gnat_gridsearch.f90"
