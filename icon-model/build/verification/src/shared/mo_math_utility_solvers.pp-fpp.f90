# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/shared/mo_math_utility_solvers.f90"
# 1 "<built-in>"
# 1 "<command-line>"
  ...
  SUBROUTINE ludec (k_dim, p_a, k_pivot)
    ...
    DO ji = 1, k_dim
      ...
      DO jj = 1, k_dim
        ...
        ENDIF
      ENDDO
# 129 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/shared/mo_math_utility_solvers.f90"
    ...
    DO jj = 1, k_dim
      ...
      k_pivot(jj) = imax
# 177 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/shared/mo_math_utility_solvers.f90"
      IF (jj /= k_dim) THEN
  ...
  SUBROUTINE choldec (k_dim, p_a, p_diag)
    ...
    DO ji = 1, k_dim
      DO jj = ji, k_dim
        ...
        IF (ji == jj) THEN
# 292 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/shared/mo_math_utility_solvers.f90"
  ...
  !! returned in @f$p\_diag(1:k\_dim)@f$.
  !!
# 360 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/shared/mo_math_utility_solvers.f90"
...
# 392 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/shared/mo_math_utility_solvers.f90"
  ...
  !! you identify @f$p\_b@f$ and @f$p\_x@f$ in the calling sequence, which is allowed.
  !!
# 555 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/shared/mo_math_utility_solvers.f90"
