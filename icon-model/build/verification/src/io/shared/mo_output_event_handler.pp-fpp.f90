# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_output_event_handler.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 231 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_output_event_handler.f90"
...
CONTAINS
  ...
  FUNCTION union_of_all_events(fct_time2simstep, fct_generate_filenames, &
    ...
    IF (icomm /= mpi_comm_null) THEN
      ...
      END IF
# 1237 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_output_event_handler.f90"
  ...
  FUNCTION is_output_step_complete(event) RESULT(ret)
    ...
    ! local variables
# 1570 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_output_event_handler.f90"
    ret = .TRUE.
...
# 1792 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_output_event_handler.f90"
  ...
  SUBROUTINE p_gatherv_event_data_1d1d(sbuf, rbuf, p_dest, counts, comm)
    ...
    INTEGER :: sum_counts
# 1860 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_output_event_handler.f90"
...
# 2176 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_output_event_handler.f90"
...
# 2233 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_output_event_handler.f90"
...
# 2274 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_output_event_handler.f90"

# 2330 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_output_event_handler.f90"
  ...
  SUBROUTINE blocking_wait_for_irecvs(event)
    TYPE(t_par_output_event), POINTER :: event
    ! local variables
# 2380 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_output_event_handler.f90"
