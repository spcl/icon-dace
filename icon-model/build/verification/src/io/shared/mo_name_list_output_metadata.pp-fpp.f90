# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_metadata.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 55 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_metadata.f90"
    TYPE(t_mem_win),      INTENT(INOUT) :: memwin ! MPI memory window
    INTEGER,              INTENT(IN)    :: nvars  ! total no. of variables
# 91 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_metadata.f90"
