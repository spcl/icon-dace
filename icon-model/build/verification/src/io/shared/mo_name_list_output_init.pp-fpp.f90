# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_init.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 192 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_init.f90"
...
# 980 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_init.f90"
...
# 1238 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_init.f90"
...
# 1265 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_init.f90"
! 1
    END IF
...
# 1288 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_init.f90"
...
# 1588 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_init.f90"
        WRITE (osched_fname, '(a,i0,a)') "output_schedule_steps_", &
          dom_sim_step_info_jstep0, "+.txt"

      ELSE
# 1601 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_init.f90"
...
# 1638 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_init.f90"
  ...
  SUBROUTINE set_patch_info()
    ...
    DO jp = 1, n_dom_out
      ...
      ENDIF
# 2102 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_init.f90"
! 1
      ...
      DO jg = 1,n_dom
        ...
        IF (.NOT. is_io) THEN
          ...
          CALL set_reorder_info_lonlat(lonlat_grids%list(jl)%grid,      &
            ...
            &                          lonlat_info(jl,jg))
        ENDIF
# 2125 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_init.f90"
! 1
      END DO ! jg
    ENDDO ! jl
  ...
  SUBROUTINE create_rank0only_ri(ri, n_pnt, is_io)
    ...
    IF (.NOT. is_io) THEN
      ...
      DO jl = 1, p_n_work-1
        ...
        ri%pe_own(jl) = 0
      END DO
# 2176 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_init.f90"
    END IF
    IF (use_async_name_list_io) THEN
...
# 2357 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_init.f90"
...
! #ifndef __NO_ICON_ATMO__
    ELSE
      ...
      ! Cells
# 2563 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_init.f90"
...
# 2625 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_init.f90"
      ...
      ! Edges
# 2664 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_init.f90"
...
# 3071 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_init.f90"
...
# 3256 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/shared/mo_name_list_output_init.f90"
! 1
