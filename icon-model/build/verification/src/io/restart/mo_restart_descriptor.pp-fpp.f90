# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/restart/mo_restart_descriptor.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
CONTAINS
  ...
  SUBROUTINE restartDescriptor_transferGlobalParameters(me)
    CLASS(t_RestartDescriptor), INTENT(INOUT) :: me
# 128 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/restart/mo_restart_descriptor.f90"
