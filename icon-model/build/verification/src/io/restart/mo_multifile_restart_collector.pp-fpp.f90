# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/restart/mo_multifile_restart_collector.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/include/handle_mpi_error.inc" 1
! ICON
!
! ---------------------------------------------------------------
! Copyright (C) 2004-2024, DWD, MPI-M, DKRZ, KIT, ETH, MeteoSwiss
...
# 16 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/restart/mo_multifile_restart_collector.f90" 2
...
# 17 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/restart/mo_multifile_restart_collector.f90" 2
MODULE mo_multifile_restart_collector

  USE, INTRINSIC :: ISO_C_BINDING, ONLY: C_F_POINTER, C_LOC
# 50 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/restart/mo_multifile_restart_collector.f90"
...
CONTAINS
  ...
  SUBROUTINE multifileRestartCollector_finalize(this)
    ...
    IF (this%allocd) THEN
# 262 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/restart/mo_multifile_restart_collector.f90"
      DEALLOCATE(this%wptr%p)

      NULLIFY(this%wptr%p, this%sBuf%d, this%sBuf%s, this%sBuf%i)
      this%allocd = .false.
    END IF
# 281 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/restart/mo_multifile_restart_collector.f90"
...
# 309 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/restart/mo_multifile_restart_collector.f90"
    nV = SIZE(vWrNow)
    ...
    IF (me%shortcut) THEN
      ...
      cBuf%s => me%sBuf%s
      cBuf%i => me%sBuf%i
# 435 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/restart/mo_multifile_restart_collector.f90"
    END IF
...
!ICON_OMP PARALLEL DO COLLAPSE(2) PRIVATE(offset)
  ...
  SUBROUTINE multifileRestartCollector_init_win(this, isize, shortcut)
    ...
    INTEGER :: i
# 500 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/restart/mo_multifile_restart_collector.f90"
    ...
    IF (shortcut) THEN
      ...
      this%srcPE(1) = 0
      this%tOffSv(:) = tOffCl(:)
# 549 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/restart/mo_multifile_restart_collector.f90"
    ELSE
      CALL finish(routine, "you screwed up!")

    END IF
    this%destPE = 0
# 572 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/restart/mo_multifile_restart_collector.f90"
...
# 611 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/restart/mo_multifile_restart_collector.f90"
...
# 640 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/restart/mo_multifile_restart_collector.f90"
