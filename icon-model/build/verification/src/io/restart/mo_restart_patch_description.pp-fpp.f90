# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/restart/mo_restart_patch_description.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
CONTAINS
  ...
  SUBROUTINE restartPatchDescription_updateOnMaster(me)
    CLASS(t_restart_patch_description), INTENT(INOUT) :: me
# 212 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/restart/mo_restart_patch_description.f90"
