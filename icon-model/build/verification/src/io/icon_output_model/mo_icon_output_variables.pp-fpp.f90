# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/icon_output_model/mo_icon_output_variables.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
!---------------------
! Upper-lower case
# 20 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/io/icon_output_model/mo_icon_output_variables.f90" 2
!=============================================================================================
MODULE mo_icon_output_variables
  ...
  TYPE t_output_collection
    REAL(sp),  POINTER, DIMENSION(:,:,:) :: output_variable
