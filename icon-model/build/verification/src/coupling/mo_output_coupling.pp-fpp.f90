# 1 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/coupling/mo_output_coupling.f90"
# 1 "<built-in>"
# 1 "<command-line>"
...
# 247 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/coupling/mo_output_coupling.f90"
  ...
  SUBROUTINE construct_output_coupling_finalize()
   ...
   CALL finish(str_module // 'construct_output_coupling_finalize', &
               "built without coupling support.")
# 302 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/coupling/mo_output_coupling.f90"
  ...
  SUBROUTINE output_coupling (valid_mask)
   ...
   CALL finish(str_module // 'output_coupling', &
               'built without coupling support')
# 447 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/coupling/mo_output_coupling.f90"
  ...
  SUBROUTINE construct_output_nml_coupling(comp_id, cell_point_id, vertex_point_id)
    ...
    CALL finish(str_module // 'construct_output_coupling', &
                'built without coupling support.')
# 529 "/home/primrose/Work/IconGrounds/icon-dace2/icon-model/src/coupling/mo_output_coupling.f90"
