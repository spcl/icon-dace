...
static const struct pvcs_info pvcs_infos[] = {
  // icon (/home/primrose/Work/IconGrounds/icon-dace2/icon-model)
  { .name = "icon",
    .revision = NULL,
    .remote_url = NULL,
    .local_branch = NULL, },
  // ecrad (/home/primrose/Work/IconGrounds/icon-dace2/icon-model/externals/ecrad)
  { .name = "ecrad",
    .revision = NULL,
    .remote_url = NULL,
    .local_branch = NULL, },
  // cdi (/home/primrose/Work/IconGrounds/icon-dace2/icon-model/externals/cdi)
  { .name = "cdi",
    .revision = NULL,
    .remote_url = NULL,
    .local_branch = NULL, },
  // mtime (/home/primrose/Work/IconGrounds/icon-dace2/icon-model/externals/mtime)
  { .name = "mtime",
    .revision = NULL,
    .remote_url = NULL,
    .local_branch = NULL, },
  // fortran-support (/home/primrose/Work/IconGrounds/icon-dace2/icon-model/externals/fortran-support)
  { .name = "fortran-support",
    .revision = NULL,
    .remote_url = NULL,
    .local_branch = NULL, },
  // math-support (/home/primrose/Work/IconGrounds/icon-dace2/icon-model/externals/math-support)
  { .name = "math-support",
    .revision = NULL,
    .remote_url = NULL,
    .local_branch = NULL, },
  // math-interpolation (/home/primrose/Work/IconGrounds/icon-dace2/icon-model/externals/math-interpolation)
