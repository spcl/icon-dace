...
START_TEST(test_create_datetime_from_valid_strings)
{
  ...
  assertDateTime("0000568028-04-07T05:42:23.113", 568028, 4, 7, 5, 42, 23, 113, "568028-04-07T05:42:23.113",
                 "5680280407T054223.113");
  assertDateTime("-568028-04-07T05:42:23.114", -568028, 4, 7, 5, 42, 23, 114, "-568028-04-07T05:42:23.114",
                 "-5680280407T054223.114");

  // Boundary datetimes
  assertDateTime("-2147483648-01-01 00:00:00.000", -2147483648, 1, 1, 0, 0, 0, 0, "-2147483648-01-01T00:00:00.000",
                 "-21474836480101T000000.000");
  assertDateTime("2147483647-12-31 23:59:59.999", 2147483647, 12, 31, 23, 59, 59, 999, "2147483647-12-31T23:59:59.999",
                 "21474836471231T235959.999");
...
void
add_mtime_datetime_test_to_suite(Suite *suite)
{
...
void
assertDateTime(const char *input_string, int64_t year, int month, int day, int hour, int minute, int second, int ms,
...
void
assertInvalidDateTime(const char *input_string)
{
  DateTime datetime = newDateTime(input_string);
...
void
genericAssertDatetimeToInteger(const char *datetime_string, int expected_value, int getNoOf(DateTime dt), const char *function_name)
{
...
void
assertNoDaysInMonth(const char *datetime_string, int expected_days)
{
  genericAssertDatetimeToInteger(datetime_string, expected_days, getNoOfDaysInMonthDateTime, "getNoOfDaysInMonthDateTime");
}

void
assertNoDaysInYear(const char *datetime_string, int expected_days)
{
  genericAssertDatetimeToInteger(datetime_string, expected_days, getNoOfDaysInYearDateTime, "getNoOfDaysInYearDateTime");
}

void
assertDayOfYear(const char *datetime_string, int expected_day)
{
  genericAssertDatetimeToInteger(datetime_string, expected_day, getDayOfYearFromDateTime, "getDayOfYearFromDateTime");
}

void
assertNoOfSecondsInDay(const char *datetime_string, int expected_days)
{
  genericAssertDatetimeToInteger(datetime_string, expected_days, getNoOfSecondsElapsedInDayDateTime,
                                 "getNoOfSecondsElapsedInDayDateTime");
}

void
assertNoOfSecondsInMonth(const char *datetime_string, int64_t expected_seconds)
{
  DateTime datetime = newDateTime(datetime_string);
...
void
assertJulianDayFromDatetime(const char *datetime_string, int expected_day, int expected_ms)
{
  DateTime datetime = newDateTime(datetime_string);
