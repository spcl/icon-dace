...
void
add_mtime_time_test_to_suite(Suite *suite)
{
...
void
assertTime(const char *input_string, int hour, int minute, int second, int ms, const char *expected_output_string,
...
void
assertInvalidTime(const char *input_string)
{
  Time time = newTime(input_string);
